...
def _impl(ctx):
    ...
    return cc_common.create_cc_toolchain_config_info(
        ctx = ctx,
        features = features,
        cxx_builtin_include_directories = ["/usr/lib/gcc-cross/aarch64-linux-gnu/11/include","/usr/aarch64-linux-gnu/include"],
...
arm64_cross_compile_cc_toolchain_config = rule(
